...
HLS_SOURCES = ../../../../testbench/tb_ecg_classifier.cpp ../../../../hls_source/ecg_trained_classifier.cpp
...
$(ObjDir)/tb_ecg_classifier.o: ../../../../testbench/tb_ecg_classifier.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../testbench/tb_ecg_classifier.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD -Wno-unknown-pragmas -Wno-unknown-pragmas  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/tb_ecg_classifier.d

$(ObjDir)/ecg_trained_classifier.o: ../../../../hls_source/ecg_trained_classifier.cpp $(ObjDir)/.dir
	$(Echo) "   Compiling ../../../../hls_source/ecg_trained_classifier.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/ecg_trained_classifier.d
