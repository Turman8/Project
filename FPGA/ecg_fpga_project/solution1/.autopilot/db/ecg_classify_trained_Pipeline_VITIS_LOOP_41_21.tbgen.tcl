set moduleName ecg_classify_trained_Pipeline_VITIS_LOOP_41_21
set isTopModule 0
...
set C_modelName {ecg_classify_trained_Pipeline_VITIS_LOOP_41_21}
...
set C_modelArgList {
	{ sext_ln39_5 int 24 regular  }
	{ gmem0 int 32 regular {axi_master 0}  }
	{ p_cast_cast int 62 regular  }
	{ tmp_109 int 6 regular  }
	{ sum_19_out int 24 regular {pointer 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "sext_ln39_5", "interface" : "wire", "bitwidth" : 24, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "tmp_109", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
 	{ "Name" : "sum_19_out", "interface" : "wire", "bitwidth" : 24, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ sext_ln39_5 sc_in sc_lv 24 signal 0 } 
	{ p_cast_cast sc_in sc_lv 62 signal 2 } 
	{ tmp_109 sc_in sc_lv 6 signal 3 } 
	{ sum_19_out sc_out sc_lv 24 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln39_5", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "sext_ln39_5", "role": "default" }} , 
 	{ "name": "p_cast_cast", "direction": "in", "datatype": "sc_lv", "bitwidth":62, "type": "signal", "bundle":{"name": "p_cast_cast", "role": "default" }} , 
 	{ "name": "tmp_109", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "tmp_109", "role": "default" }} , 
 	{ "name": "sum_19_out", "direction": "out", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "sum_19_out", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_9_3_16_1_1_U13", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_16s_16s_32ns_32_4_1_U14", "Parent" : "0"},
...
set Spec2ImplPortList { 
	sext_ln39_5 { ap_none {  { sext_ln39_5 in_data 0 24 } } }
	...
	tmp_109 { ap_none {  { tmp_109 in_data 0 6 } } }
	sum_19_out { ap_vld {  { sum_19_out out_data 1 24 }  { sum_19_out_ap_vld out_vld 1 1 } } }
