set moduleName ecg_classify_trained_Pipeline_VITIS_LOOP_57_4
set isTopModule 0
...
set C_modelName {ecg_classify_trained_Pipeline_VITIS_LOOP_57_4}
...
set C_modelArgList {
	{ sext_ln55_2 int 24 regular  }
	{ zext_ln53_1 int 6 regular  }
	...
	{ sum_6_out int 24 regular {pointer 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "sext_ln55_2", "interface" : "wire", "bitwidth" : 24, "direction" : "READONLY"} , 
 	{ "Name" : "zext_ln53_1", "interface" : "wire", "bitwidth" : 6, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "sum_6_out", "interface" : "wire", "bitwidth" : 24, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ sext_ln55_2 sc_in sc_lv 24 signal 0 } 
	{ zext_ln53_1 sc_in sc_lv 6 signal 1 } 
	...
	{ sum_6_out sc_out sc_lv 24 signal 130 } 
	{ sum_6_out_ap_vld sc_out sc_logic 1 outvld 130 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln55_2", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "sext_ln55_2", "role": "default" }} , 
 	{ "name": "zext_ln53_1", "direction": "in", "datatype": "sc_lv", "bitwidth":6, "type": "signal", "bundle":{"name": "zext_ln53_1", "role": "default" }} , 
 	...
 	{ "name": "sum_6_out", "direction": "out", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "sum_6_out", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_257_7_16_1_1_U40", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_9_3_16_1_1_U41", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_16s_16s_32ns_32_4_1_U42", "Parent" : "0"},
...
set Spec2ImplPortList { 
	sext_ln55_2 { ap_none {  { sext_ln55_2 in_data 0 24 } } }
	zext_ln53_1 { ap_none {  { zext_ln53_1 in_data 0 6 } } }
	...
	sum_6_out { ap_vld {  { sum_6_out out_data 1 24 }  { sum_6_out_ap_vld out_vld 1 1 } } }
