set moduleName ecg_classify_trained_Pipeline_VITIS_LOOP_88_814
set isTopModule 0
...
set C_modelName {ecg_classify_trained_Pipeline_VITIS_LOOP_88_814}
...
set C_modelArgList {
	...
	{ sum_28_out int 24 regular {pointer 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "hidden3", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "sum_28_out", "interface" : "wire", "bitwidth" : 24, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ sum_28_out sc_out sc_lv 24 signal 32 } 
	{ sum_28_out_ap_vld sc_out sc_logic 1 outvld 32 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sum_28_out", "direction": "out", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "sum_28_out", "role": "default" }} , 
 	{ "name": "sum_28_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "sum_28_out", "role": "ap_vld" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_65_5_16_1_1_U1065", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_9_3_16_1_1_U1066", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_16s_16s_32ns_32_4_1_U1067", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	sum_28_out { ap_vld {  { sum_28_out out_data 1 24 }  { sum_28_out_ap_vld out_vld 1 1 } } }
