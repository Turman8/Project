set moduleName ecg_classify_trained_Pipeline_VITIS_LOOP_73_69
set isTopModule 0
...
set C_modelName {ecg_classify_trained_Pipeline_VITIS_LOOP_73_69}
...
set C_modelArgList {
	{ sext_ln71_11 int 24 regular  }
	{ tmp_114 int 3 regular  }
	...
	{ sum_40_out int 24 regular {pointer 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "sext_ln71_11", "interface" : "wire", "bitwidth" : 24, "direction" : "READONLY"} , 
 	{ "Name" : "tmp_114", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "sum_40_out", "interface" : "wire", "bitwidth" : 24, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ sext_ln71_11 sc_in sc_lv 24 signal 0 } 
	{ tmp_114 sc_in sc_lv 3 signal 1 } 
	...
	{ sum_40_out sc_out sc_lv 24 signal 66 } 
	{ sum_40_out_ap_vld sc_out sc_logic 1 outvld 66 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln71_11", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "sext_ln71_11", "role": "default" }} , 
 	{ "name": "tmp_114", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "tmp_114", "role": "default" }} , 
 	...
 	{ "name": "sum_40_out", "direction": "out", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "sum_40_out", "role": "default" }} , 
 	{ "name": "sum_40_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "sum_40_out", "role": "ap_vld" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_129_6_16_1_1_U802", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_9_3_16_1_1_U803", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_16s_16s_32ns_32_4_1_U804", "Parent" : "0"},
...
set Spec2ImplPortList { 
	sext_ln71_11 { ap_none {  { sext_ln71_11 in_data 0 24 } } }
	tmp_114 { ap_none {  { tmp_114 in_data 0 3 } } }
	...
	sum_40_out { ap_vld {  { sum_40_out out_data 1 24 }  { sum_40_out_ap_vld out_vld 1 1 } } }
