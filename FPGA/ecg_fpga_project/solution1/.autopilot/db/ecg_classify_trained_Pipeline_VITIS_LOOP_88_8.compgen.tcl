...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler ecg_classify_trained_sparsemux_65_5_16_1_1 BINDTYPE {op} TYPE {sparsemux} IMPL {auto}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { sum_5_out { O 24 vector } sum_5_out_ap_vld { O 1 bit } } \
} "
}
