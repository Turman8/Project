set moduleName ecg_classify_trained_Pipeline_VITIS_LOOP_88_813
set isTopModule 0
...
set C_modelName {ecg_classify_trained_Pipeline_VITIS_LOOP_88_813}
...
set C_modelArgList {
	...
	{ sum_23_out int 24 regular {pointer 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "hidden3", "interface" : "wire", "bitwidth" : 16, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "sum_23_out", "interface" : "wire", "bitwidth" : 24, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ sum_23_out sc_out sc_lv 24 signal 32 } 
	{ sum_23_out_ap_vld sc_out sc_logic 1 outvld 32 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sum_23_out", "direction": "out", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "sum_23_out", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_65_5_16_1_1_U1027", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_9_3_16_1_1_U1028", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_16s_16s_32ns_32_4_1_U1029", "Parent" : "0"},
...
set Spec2ImplPortList { 
	...
	sum_23_out { ap_vld {  { sum_23_out out_data 1 24 }  { sum_23_out_ap_vld out_vld 1 1 } } }
