...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler ecg_classify_trained_sparsemux_9_3_16_1_1 BINDTYPE {op} TYPE {sparsemux} IMPL {auto}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler ecg_classify_trained_mac_muladd_16s_16s_32ns_32_4_1 BINDTYPE {op} TYPE {all} IMPL {dsp_slice} LATENCY 3
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir I \
    corename dense_weights \
    op interface \
    ports { dense_weights_address0 { O 13 vector } dense_weights_ce0 { O 1 bit } dense_weights_q0 { I 32 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'dense_weights'"
}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { sum_2_out { O 24 vector } sum_2_out_ap_vld { O 1 bit } } \
} "
}
