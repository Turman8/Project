set moduleName ecg_classify_trained_Pipeline_VITIS_LOOP_57_44
set isTopModule 0
...
set C_modelName {ecg_classify_trained_Pipeline_VITIS_LOOP_57_44}
...
set C_modelArgList {
	{ sext_ln55_5 int 24 regular  }
	{ tmp_111 int 5 regular  }
	...
	{ sum_25_out int 24 regular {pointer 1}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "sext_ln55_5", "interface" : "wire", "bitwidth" : 24, "direction" : "READONLY"} , 
 	{ "Name" : "tmp_111", "interface" : "wire", "bitwidth" : 5, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "sum_25_out", "interface" : "wire", "bitwidth" : 24, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ sext_ln55_5 sc_in sc_lv 24 signal 0 } 
	{ tmp_111 sc_in sc_lv 5 signal 1 } 
	...
	{ sum_25_out sc_out sc_lv 24 signal 130 } 
	{ sum_25_out_ap_vld sc_out sc_logic 1 outvld 130 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln55_5", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "sext_ln55_5", "role": "default" }} , 
 	{ "name": "tmp_111", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "tmp_111", "role": "default" }} , 
 	...
 	{ "name": "sum_25_out", "direction": "out", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "sum_25_out", "role": "default" }} , 
 	{ "name": "sum_25_out_ap_vld", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "outvld", "bundle":{"name": "sum_25_out", "role": "ap_vld" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_257_7_16_1_1_U177", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_9_3_16_1_1_U178", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_16s_16s_32ns_32_4_1_U179", "Parent" : "0"},
...
set Spec2ImplPortList { 
	sext_ln55_5 { ap_none {  { sext_ln55_5 in_data 0 24 } } }
	tmp_111 { ap_none {  { tmp_111 in_data 0 5 } } }
	...
	sum_25_out { ap_vld {  { sum_25_out out_data 1 24 }  { sum_25_out_ap_vld out_vld 1 1 } } }
