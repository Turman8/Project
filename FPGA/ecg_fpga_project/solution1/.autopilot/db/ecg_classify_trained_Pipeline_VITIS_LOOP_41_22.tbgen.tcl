set moduleName ecg_classify_trained_Pipeline_VITIS_LOOP_41_22
set isTopModule 0
...
set C_modelName {ecg_classify_trained_Pipeline_VITIS_LOOP_41_22}
...
set C_modelArgMapList {[ 
	{ "Name" : "sext_ln39_8", "interface" : "wire", "bitwidth" : 24, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "sum_36_out", "interface" : "wire", "bitwidth" : 24, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ sext_ln39_8 sc_in sc_lv 24 signal 0 } 
	{ p_cast_cast sc_in sc_lv 62 signal 2 } 
	{ tmp_117 sc_in sc_lv 5 signal 3 } 
	{ sum_36_out sc_out sc_lv 24 signal 4 } 
	{ sum_36_out_ap_vld sc_out sc_logic 1 outvld 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sext_ln39_8", "direction": "in", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "sext_ln39_8", "role": "default" }} , 
 	...
 	{ "name": "sum_36_out", "direction": "out", "datatype": "sc_lv", "bitwidth":24, "type": "signal", "bundle":{"name": "sum_36_out", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.sparsemux_9_3_16_1_1_U22", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mac_muladd_16s_16s_32ns_32_4_1_U23", "Parent" : "0"},
...
set Spec2ImplPortList { 
	sext_ln39_8 { ap_none {  { sext_ln39_8 in_data 0 24 } } }
	...
	sum_36_out { ap_vld {  { sum_36_out out_data 1 24 }  { sum_36_out_ap_vld out_vld 1 1 } } }
